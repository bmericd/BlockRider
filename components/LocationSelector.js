...
const style = {
  wrapper: "pt-2",
  searchHeader:
    "w-full font-bold text-left flex items-center text-3xl p-4 overflow-scroll scrollbar-hide ",
  ...
  svgContainer: "mx-1",
  input:
    "my-2 rounded-2 p-2 outline-none border-none bg-transparent h-full w-full",
  verticalLine:
    "w-0 h-[2rem] border-black border absolute z-10 left-[2.3rem] top-[2rem]",
};
